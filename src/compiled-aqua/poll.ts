                                       ...
                                       (seq
                                        (seq
                                         (seq
                                          ...
                                          (new $array-inline-16
                                           (seq
                                            (ap log-16-0.$.info.pat_id $array-inline-16)
                                                  ...
                                                  (seq
                                                   (seq
                                                    (seq
                                                     (seq
                                                      (seq
                                                       (call %init_peer_id% ("chain_connector" "register_worker") [log-16-0.$.info.pat_id -worker_id-flat-0.$.[0] -chain-arg- log-16-0_flat_flat] ret-99)
